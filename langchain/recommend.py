...
def recommend(userName, environment_description, text_mood, text_music_types, text_more_details):
    ...
    response = chain.invoke({"JSON_format": JSON_format, "environment_description": environment_description, "text_mood": text_mood,
...
def final_recommend(userName, environment_description, text_mood, text_music_types, text_more_details):
    ...
    response = recommend(userName, environment_description,
...
# Example usage
result = final_recommend("olieoil", temp_environment_description,
                         "I am feeling happy", "pop, rock", "I want to listen to some new songs")
print(result)
