...
text_mood = "happy"
text_music_types = ["pop, edm"]
text_more_details = "I like upbeat music"
eval = mood_eval(text_mood, text_music_types, text_more_details)
tar_feat = final_recommend(text_mood, text_music_types, text_more_details)
